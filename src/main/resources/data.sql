...
VALUES ('fa211ceb-be09-4370-9a98-a55ea8fed578', 'hntrnn12@gmail.com',
        ...
        'Viet Han', 'Trinh', TRUE, FALSE, '2003-12-02', NULL,
...
VALUES ('9a39e0ff-27a0-4789-8ba2-b7e49677db34', 'hntrnn195@gmail.com',
        ...
        'Mai Anh', 'Do', TRUE, FALSE, '2001-10-06', 'rKftfWen.jpg',
...
VALUES ('4a39e0fe-27a0-4789-8ba2-b7e49677db34', 'hntrnn19@gmail.com',
        '$2a$10$Z9mB1/tSfBLpcxX.Y4.KDeDNoqNivdRgsepjIEgeH3AmtBovDtPIa',
        'Linh', 'Khanh', TRUE, FALSE, '2001-10-06', 'riftfWen.jpg',
        '0987666543', '2024-09-12 07:08:18');
...
VALUES (1, N'Pro Flutter 2025', 'XgYqkzQJ.jpg',
        N'Khóa học Pro Flutter sẽ cung cấp cho bạn các kiến thức và kĩ năng...',
        N'Khóa học được lồng ghép các yêu cầu nâng cao vào các bài học để bạn có thể đáp ứng được yêu cầu của nhà tuyển dụng ngày càng tăng#Sau khi kết thúc khóa học bạn có thể tự tin đi thực tập, intern, fresher vị trí Mobile App Developer với Flutter#Khóa học sẽ được cập nhật, thay đổi nội dung mới nhất mà không có thông báo trước',
        4499000, 1999000,
        344, 234, '2024-09-12 07:08:18', NULL, 8),
       (2, N'Khóa học lập trình Java cơ bản',
        'IypolLPp.jpg',
        N'Khóa học này cung cấp cho các bạn kiến thức từ cơ bản của ngôn ngữ lập trình Java.',
        N'Khóa học được lồng ghép các yêu cầu nâng cao vào các bài học để bạn có thể đáp ứng được yêu cầu của nhà tuyển dụng ngày càng tăng#Sau khi kết thúc khóa học bạn có thể tự tin đi thực tập, intern, fresher vị trí Mobile App Developer với Flutter#Khóa học sẽ được cập nhật, thay đổi nội dung mới nhất mà không có thông báo trước',
        399000, 349000,
        554, 234, '2024-09-12 07:08:18', NULL, 1),
       (3, N'Lập trình C cho người mới', 'NvosnH7x.jpg',
        N'Đây là khóa học lập trình HƯỚNG CẤU TRÚC dựa trên nền tảng ngôn ngữ lập trình C.',
        N'Khóa học được lồng ghép các yêu cầu nâng cao vào các bài học để bạn có thể đáp ứng được yêu cầu của nhà tuyển dụng ngày càng tăng#Sau khi kết thúc khóa học bạn có thể tự tin đi thực tập, intern, fresher vị trí Mobile App Developer với Flutter#Khóa học sẽ được cập nhật, thay đổi nội dung mới nhất mà không có thông báo trước',
        899000, 520000,
        123, 45, '2024-09-12 07:08:18', NULL, 4),
       (4, 'Android Jetpack Compose', 'KI7iFcji.jpg',
        N'Khóa học này sẽ hướng dẫn bạn tạo ứng dụng Android hoàn chỉnh...',
        N'Khóa học được lồng ghép các yêu cầu nâng cao vào các bài học để bạn có thể đáp ứng được yêu cầu của nhà tuyển dụng ngày càng tăng#Sau khi kết thúc khóa học bạn có thể tự tin đi thực tập, intern, fresher vị trí Mobile App Developer với Flutter#Khóa học sẽ được cập nhật, thay đổi nội dung mới nhất mà không có thông báo trước',
        899000, 520000,
        234, 123, '2024-09-12 07:08:18', NULL, 6),
       (5, N'Android Kotlin Thực Chiến',
        'As3xxLM1.jpg',
        N'Khóa học này sẽ hướng dẫn bạn THỰC HÀNH tạo ứng dụng Android native...',
        N'Khóa học được lồng ghép các yêu cầu nâng cao vào các bài học để bạn có thể đáp ứng được yêu cầu của nhà tuyển dụng ngày càng tăng#Sau khi kết thúc khóa học bạn có thể tự tin đi thực tập, intern, fresher vị trí Mobile App Developer với Flutter#Khóa học sẽ được cập nhật, thay đổi nội dung mới nhất mà không có thông báo trước',
        2199000, 1499000,
        789, 345, '2024-09-12 07:08:18', NULL, 6),
       (6, N'Git Cơ Bản & Nâng Cao', 'dXCDEoao.jpg',
        N'Nội dung khóa học này sẽ hướng dẫn bạn sử dụng các lệnh trong công cụ...',
       ...
       (8, N'Lập trình C# OOP từ cơ bản đến nâng cao',
        'wTJPergu.jpg',
        N'Đây là khóa học lập trình HƯỚNG ĐỐI TƯỢNG trên nền tảng C#.',
        N'Khóa học được lồng ghép các yêu cầu nâng cao vào các bài học để bạn có thể đáp ứng được yêu cầu của nhà tuyển dụng ngày càng tăng#Sau khi kết thúc khóa học bạn có thể tự tin đi thực tập, intern, fresher vị trí Mobile App Developer với Flutter#Khóa học sẽ được cập nhật, thay đổi nội dung mới nhất mà không có thông báo trước',
        1799000, 729000,
